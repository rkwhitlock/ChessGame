class ChessBoard {
  ...
  insertStartingPieces = () => {
    this.grid[0][0].setChessPiece(
      new Rook(
        new Array(0, 0),
        'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/white-rook.png',
        'White',
        this
      ),
      true
    ...
    this.grid[0][1].setChessPiece(
      new Knight(
        new Array(0, 1),
        'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/white-knight.png',
        'White',
        this
      ),
      true
    ...
    this.grid[0][2].setChessPiece(
      new Bishop(
        new Array(0, 2),
        'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/white-bishop.png',
        'White',
        this
      ),
      true
    ...
    this.grid[0][3].setChessPiece(
      new King(
        new Array(0, 3),
        'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/white-king.png',
        'White',
        this
      ),
      true
    ...
    this.grid[0][4].setChessPiece(
      new Queen(
        new Array(0, 4),
        'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/white-queen.png',
        'White',
        this
      ),
      true
    ...
    for (let i = 0; i < 8; i++) {
      this.grid[1][i].setChessPiece(
        new Pawn(
          new Array(1, i),
          'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/white-pawn.png',
          'White',
          this
        ),
        true
    ...
    for (let i = 0; i < 8; i++) {
      this.grid[6][i].setChessPiece(
        new Pawn(
          new Array(6, i),
          'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/black-pawn.png',
          'Black',
          this
        ),
        true
    ...
    this.grid[7][0].setChessPiece(
      new Rook(
        new Array(7, 0),
        'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/black-rook.png',
        'Black',
        this
      ),
      true
    ...
    this.grid[7][1].setChessPiece(
      new Knight(
        new Array(7, 1),
        'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/black-knight.png',
        'Black',
        this
      ),
      true
    ...
    this.grid[7][2].setChessPiece(
      new Bishop(
        new Array(7, 2),
        'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/black-bishop.png',
        'Black',
        this
      ),
      true
    ...
    this.grid[7][3].setChessPiece(
      new King(
        new Array(7, 3),
        'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/black-king.png',
        'Black',
        this
      ),
      true
    ...
    this.grid[7][4].setChessPiece(
      new Queen(
        new Array(7, 4),
        'https://rkwhitlock.github.io/ChessGame/ChessGame/static/chessgame/img/black-queen.png',
        'Black',
        this
      ),
      true
